...
var hljs=function(){"use strict";var e={exports:{}};function n(e){
    ...
    ;return Object.assign(n,e),n};class c{constructor(){
    ...
    function h(e){return RegExp(e.toString()+"|").exec("").length-1}
    const _=/\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./
    ...
    ;function $(e,n,t="keyword"){const a=Object.create(null)
    ;return"string"==typeof e?i(t,e.split(" ")):Array.isArray(e)?i(t,e):Object.keys(e).forEach((t=>{
        Object.assign(a,$(e[t],n,t))})),a;function i(e,t){
        n&&(t=t.map((e=>e.toLowerCase()))),t.forEach((n=>{const t=n.split("|")
        ;a[t[0]]=[e,U(t[0],t[1])]}))}}function U(e,n){
        return n?Number(n):(e=>j.includes(e.toLowerCase()))(e)?0:1}const P={},K=e=>{
        console.error(e)},H=(e,...n)=>{console.log("WARN: "+e,...n)},q=(e,n)=>{
        P[`${e}/${n}`]||(console.log(`Deprecated as of ${e}. ${n}`),P[`${e}/${n}`]=!0)
    },Z=Error();function G(e,n,{key:t}){let a=0;const i=e[t],r={},s={}
    ;for(let e=1;e<=n.length;e++)s[e+a]=i[e],r[e+a]=!0,a+=h(n[e-1])
    ;e[t]=s,e[t]._emit=r,e[t]._multi=!0}function W(e){(e=>{
        ...
        ;if(r.isCompiled)return o
            ;[D,L,W,F].forEach((e=>e(r,s))),e.compilerExtensions.forEach((e=>e(r,s))),
            r.__beforeBegin=null,[I,B,z].forEach((e=>e(r,s))),r.isCompiled=!0;let c=null
    ...
    const J=a,Y=i,ee=Symbol("nomatch");var ne=(n=>{
        ...
        ;const o="Could not find the language '{}', did you forget to load/include a language module?",c={
            ...
            return d.noHighlightRe.test(e)}function _(e,n,t){let a="",i=""
        ;"object"==typeof n?(a=e,
            t=n.ignoreIllegals,i=n.language):(q("10.7.0","highlight(lang, code, ...args) has been deprecated."),
            q("10.7.0","Please use highlight(code, options) instead.\nhttps://github.com/highlightjs/highlight.js/issues/2277"),
            i=e,a=n),void 0===t&&(t=!0);const r={code:a,language:i};O("before:highlight",r)
        ;const s=r.result?r.result:f(r.language,r.code,t)
        ;return s.code=r.code,O("after:highlight",s),s}function f(e,n,i,r){
            ...
            ;t+=S.substring(e),M.addText(t)}function g(){null!=x.subLanguage?(()=>{
                if(""===S)return;let e=null;if("string"==typeof x.subLanguage){
                    if(!a[x.subLanguage])return void M.addText(S)
            ...
            })():l(),S=""}function u(e,n){let t=1;const a=n.length-1;for(;t<=a;){
                ...
                e.beginScope&&(e.beginScope._wrap?(M.addKeyword(S,w.classNameAliases[e.beginScope._wrap]||e.beginScope._wrap),
                    S=""):e.beginScope._multi&&(u(e.beginScope,n),S="")),x=Object.create(e,{parent:{
                        value:x}}),x}function m(e,n,a){let i=((e,n)=>{const t=e&&e.exec(n)
            ...
            ;e["on:end"](n,a),a.isMatchIgnored&&(i=!1)}if(i){
                ...
                return 0===x.matcher.regexIndex?(S+=e[0],1):(R=!0,0)}function h(e){
                const t=e[0],a=n.substring(e.index),i=m(x,e,a);if(!i)return ee;const r=x
                ;x.endScope&&x.endScope._wrap?(g(),
                    M.addKeyword(t,x.endScope._wrap)):x.endScope&&x.endScope._multi?(g(),
                    u(x.endScope,e)):r.skip?S+=t:(r.returnEnd||r.excludeEnd||(S+=t),
                    g(),r.excludeEnd&&(S=t));do{
                    x.scope&&M.closeNode(),x.skip||x.subLanguage||(A+=x.relevance),x=x.parent
                }while(x!==i.parent);return i.starts&&b(i.starts,e),r.returnEnd?0:t.length}
            let _={};function y(a,r){const o=r&&r[0];if(S+=a,null==o)return g(),0
            ...
            ;if(!w)throw K(o.replace("{}",e)),Error('Unknown language: "'+e+'"')
                ;const N=Q(w);let k="",x=r||N;const O={},M=new d.__emitter(d);(()=>{const e=[]
            ;for(let n=x;n!==w;n=n.parent)n.scope&&e.unshift(n.scope)
            ;e.forEach((e=>M.openNode(e)))})();let S="",A=0,C=0,T=0,R=!1;try{
                for(x.matcher.considerAll();;){
                    T++,R?R=!1:x.matcher.considerAll(),x.matcher.lastIndex=C
                    ;const e=x.matcher.exec(n);if(!e)break;const t=y(n.substring(C,e.index),e)
                    ;C=e.index+t}
                return y(n.substring(C)),M.closeAllNodes(),M.finalize(),k=M.toHTML(),{
                    language:e,value:k,relevance:A,illegal:!1,_emitter:M,_top:x}}catch(t){
                if(t.message&&t.message.includes("Illegal"))return{language:e,value:J(n),
                    ...
                    language:e,value:J(n),illegal:!1,relevance:0,errorRaised:t,_emitter:M,_top:x}
        ...
        "undefined"!=typeof window&&window.addEventListener&&window.addEventListener("DOMContentLoaded",(()=>{
            w&&N()}),!1),Object.assign(n,{highlight:_,highlightAuto:E,highlightAll:N,
            highlightElement:y,
    ...
    ;const m=[].concat(u,c.contains),p=m.concat([{begin:/\(/,end:/\)/,keywords:i,
        contains:["self"].concat(m)}]),h={className:"params",begin:/\(/,end:/\)/,
        excludeBegin:!0,excludeEnd:!0,keywords:i,contains:p},_={variants:[{
            match:[/class/,/\s+/,t,/\s+/,/extends/,/\s+/,n.concat(t,"(",n.concat(/\./,t),")*")],
            scope:{1:"keyword",3:"title.class",5:"keyword",7:"title.class.inherited"}},{
            match:[/class/,/\s+/,t],scope:{1:"keyword",3:"title.class"}}]},f={relevance:0,
        match:n.either(/\bJSON/,/\b[A-Z][a-z]+([A-Z][a-z]*|\d)*/,/\b[A-Z]{2,}([A-Z][a-z]+|\d)+([A-Z][a-z]*)*/,/\b[A-Z]{2,}[a-z]+([A-Z][a-z]+|\d)*([A-Z][a-z]*)*/),
        className:"title.class",keywords:{_:[...re,...se]}},E={variants:[{
    ...
    ;return{name:"Javascript",aliases:["js","jsx","mjs","cjs"],keywords:i,exports:{
        ...
        contains:[e.SHEBANG({label:"shebang",binary:"node",relevance:5}),{
            ...
            className:"variable.constant"},_,v,{match:/\$[(.]/}]}}
    ...
    ;var Fe=Object.freeze({__proto__:null,grmr_python:e=>{
            const n=e.regex,t=/[\p{XID_Start}_]\p{XID_Continue}*/u,a=["and","as","assert","async","await","break","case","class","continue","def","del","elif","else","except","finally","for","from","global","if","import","in","is","lambda","match","nonlocal|10","not","or","pass","raise","return","try","while","with","yield"],i={
                ...
                illegal:/(<\/|->|\?)|=>/,contains:[r,u,{begin:/\bself\b/},{beginKeywords:"if",
                    relevance:0},c,b,e.HASH_COMMENT_MODE,{match:[/\bdef/,/\s+/,t],scope:{
        ...
        grmr_xml:e=>{
            ...
            },b=[u,c,r,t,e.C_BLOCK_COMMENT_MODE,o,s],m={variants:[{begin:/=/,end:/;/},{
        ...
        grmr_clojure:e=>{
            const n="a-zA-Z_\\-!.?+*=<>&'",t="[#]?["+n+"]["+n+"0-9/;:$#]*",a="def defonce defprotocol defstruct defmulti defmethod defn- defn defmacro deftype defrecord",i={
                ...
                },r={begin:t,relevance:0},s={scope:"number",relevance:0,variants:[{
                    ...
                    match:/,/,relevance:0},g=e.COMMENT(";","$",{relevance:0}),u={
                    className:"literal",begin:/\b(true|false|nil)\b/},b={
                    begin:"\\[|(#::?"+t+")?\\{",end:"[\\]\\}]",relevance:0},m={className:"symbol",
                    begin:"[:]{1,2}"+t},p={begin:"\\(",end:"\\)"},h={endsWithParent:!0,relevance:0
                },_={keywords:i,className:"name",begin:t,relevance:0,starts:h
                },f=[d,p,o,c,l,g,m,b,s,u,r],E={beginKeywords:a,keywords:{$pattern:t,keyword:a},
                    end:'(\\[|#|\\d|"|:|\\{|\\)|\\(|$)',contains:[{className:"title",begin:t,
                        relevance:0,excludeEnd:!0,endsParent:!0}].concat(f)}
            ;return p.contains=[E,_,h],h.contains=f,b.contains=f,{name:"Clojure",
                aliases:["clj","edn"],illegal:/\S/,contains:[d,p,o,c,l,g,m,b,s,u]}},
        grmr_csharp:e=>{const n={
        ...
        ;s.contains=[l,c,i,e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,a,e.C_BLOCK_COMMENT_MODE],
            ...
            ;return{name:"Java",aliases:["jsp"],keywords:i,illegal:/<\/|#/,
                contains:[e.COMMENT("/\\*\\*","\\*/",{relevance:0,contains:[{begin:/\w+@/,
                    ...
                    },e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},be,r]}},grmr_swift:e=>{
            const n={match:/\s+/,relevance:0},t=e.COMMENT("/\\*","\\*/",{contains:["self"]
            }),a=[e.C_LINE_COMMENT_MODE,t],i={match:[/\./,p(...he,..._e)],className:{
                    2:"keyword"}},r={match:m(/\./,p(...Ee)),relevance:0
            },s=Ee.filter((e=>"string"==typeof e)).concat(["_|0"]),o={variants:[{
                    className:"keyword",
                    match:p(...Ee.filter((e=>"string"!=typeof e)).concat(fe).map(pe),..._e)}]},c={
                $pattern:p(/\b\w+/,/#\w+/),keyword:s.concat(Ne),literal:ye},l=[i,r,o],d=[{
            ...
            }],h="([0-9a-fA-F]_*)+",_={className:"number",relevance:0,variants:[{
                    match:"\\b(([0-9]_*)+)(\\.(([0-9]_*)+))?([eE][+-]?(([0-9]_*)+))?\\b"},{
                    match:`\\b0x(${h})(\\.(${h}))?([pP][+-]?(([0-9]_*)+))?\\b`},{
                ...
                className:"variable",match:`\\$${Se}+`}],O=[{match:/(@|#(un)?)available/,
                className:"keyword",starts:{contains:[{begin:/\(/,end:/\)/,keywords:Re,
                        contains:[...b,_,v]}]}},{className:"keyword",match:m(/@/,p(...Te))},{
            ...
            ;const A={begin:/\(/,end:/\)/,relevance:0,keywords:c,contains:["self",{
                    ...
                    },...a,...l,...d,...b,_,v,...x,...O,M]},C={begin:/</,end:/>/,contains:[...a,M]
                    ...
                    },...a,...l,...b,_,v,...O,M,A],endsParent:!0,illegal:/["']/},R={
            ...
            ;n.keywords=c;const t=[...l,...d,...b,_,v,...x];n.contains=[...t,{begin:/\(/,
                ...
                },...l,...d,...b,_,v,...x,...O,M,A]}},grmr_css:e=>{const n=e.regex,t=(e=>({
            ...
            },t.CSS_VARIABLE,{className:"attribute",begin:"\\b("+ze.join("|")+")\\b"},{
                begin:/:/,end:/[;}{]/,
            ...
            const n=e.regex,t="([a-zA-Z_]\\w*[!?=]?|[-+~]@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?)",a=n.either(/\b([A-Z]+[a-z0-9]+)+/,/\b([A-Z]+[a-z0-9]+)+[A-Z]+/),i=n.concat(a,/(::\w+)*/),r={
                ...
                },c=[e.COMMENT("#","$",{contains:[s]}),e.COMMENT("^=begin","^=end",{
                    contains:[s],relevance:10}),e.COMMENT("^__END__",e.MATCH_NOTHING_RE)],l={
        ...
        grmr_makefile:e=>{const n={className:"variable",variants:[{
            ...
            name:"Makefile",aliases:["mk","mak","make"],keywords:{$pattern:/[\w-]+/,
                ...
                end:/$/,keywords:{$pattern:/[\.\w]+/,keyword:".PHONY"}},r]}},grmr_go:e=>{
            const n={
        ...
        ;const s=e.inherit(e.TITLE_MODE,{begin:a}),o="(\\(.*\\)\\s*)?\\B[-=]>",c={
            ...
            contains:[...r,e.COMMENT("###","###"),e.HASH_COMMENT_MODE,{className:"function",
                ...
                returnBegin:!0,returnEnd:!0,relevance:0}]}},grmr_bash:e=>{
            const n=e.regex,t={},a={begin:/\$\{/,end:/\}/,contains:["self",{begin:/:-/,
                ...
                },contains:[c,e.SHEBANG(),l,o,e.HASH_COMMENT_MODE,r,{match:/(\/[a-z._-]+)+/},s,{
        ...
        grmr_ini:e=>{const n=e.regex,t={className:"number",relevance:0,variants:[{
            ...
            contains:[a,{className:"section",begin:/\[+/,end:/\]+/},{
                ...
                className:"attr",starts:{end:/$/,contains:[a,o,r,i,s,t]}}]}},grmr_rust:e=>{
        ...
        grmr_handlebars:e=>{const n=e.regex,t={$pattern:/[\w.\/]+/,
            ...
            },a=/\[\]|\[[^\]]+\]/,i=/[^\s!"#%&'()*+,.\/;<=>@\[\\\]^`{|}~]+/,r=n.either(/""|"[^"]+"/,/''|'[^']+'/,a,i),s=n.concat(n.optional(/\.|\.\/|\//),r,n.anyNumberOfTimes(n.concat(/(\.|\/)/,r))),o=n.concat("(",a,"|",i,")(?==)"),c={
                begin:s},l=e.inherit(c,{keywords:{$pattern:/[\w.\/]+/,
        ...
        ;d.contains=[b];const m=e.inherit(c,{keywords:t,className:"name",
            ...
            }),h=e.inherit(c,{className:"name",keywords:t,starts:e.inherit(u,{end:/\}\}/})})
        ...
        grmr_prolog:e=>{const n={begin:/\(/,end:/\)/,relevance:0},t={begin:/\[/,end:/\]/
        ...
        },e.C_NUMBER_MODE];return n.contains=r,t.contains=r,{name:"Prolog",
            contains:r.concat([{begin:/\.$/}])}},grmr_typescript:e=>{
            const n=de(e),t=["any","void","number","boolean","string","object","never","symbol","bigint","unknown"],a={
                beginKeywords:"namespace",end:/\{/,excludeEnd:!0,
                contains:[n.exports.CLASS_REFERENCE]},i={beginKeywords:"interface",end:/\{/,
                excludeEnd:!0,keywords:{keyword:"interface extends",built_in:t},
                contains:[n.exports.CLASS_REFERENCE]},r={$pattern:te,
                keyword:ae.concat(["type","namespace","interface","public","private","protected","implements","declare","abstract","readonly","enum","override"]),
                literal:ie,built_in:le.concat(t),"variable.language":ce},s={className:"meta",
            ...
            ;return{name:"JSON",keywords:{literal:n},contains:[{className:"attr",
                ...
                illegal:"\\S"}}});const je=ne;for(const e of Object.keys(Fe)){
        const n=e.replace("grmr_","").replace("_","-");je.registerLanguage(n,Fe[e])}
    return je}()
