    ...
    1: [function (t, e) {
        ...
        var n = t("./calculateOffset"), o = function (t, e) {
            return [].forEach.call(t, function (t) {
                ...
                let direction;
                direction = !!$('#Horizontal').is('*');
                t.node.classList.add("aos-init"), t.position = direction ? (t.node.offsetLeft - document.documentElement.clientWidth) + document.documentElement.clientHeight : n(t.node, e.offset)
            }), t
        };
        e.exports = o
